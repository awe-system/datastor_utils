...
namespace log4cpp
{
   class LOG4CPP_EXPORT TriggeringEventEvaluatorFactory
   {
      public:
         ...
         typedef std::unique_ptr<TriggeringEventEvaluator> (*create_function_t)(const params_t& params);
         ...
         std::unique_ptr<TriggeringEventEvaluator> create(const std::string& class_name, const params_t& params);
