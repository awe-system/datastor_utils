...
#define AWE_LOG_WARN(msg, ...)  ss_log_warn(postfix(msg), ##__VA_ARGS__)
#define AWE_LOG_INFO(msg, ...)  ss_log_info(postfix(msg), ##__VA_ARGS__)
#define AWE_LOG_DEBUG(msg, ...) ss_log_debug(postfix(msg), ##__VA_ARGS__)
